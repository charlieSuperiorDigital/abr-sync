  ...
  return (
    <div className="bg-slate-100 p-6 rounded-lg space-y-6">
      ...
      <div className="grid grid-cols-2 gap-x-24 gap-y-4">
        <div>
          <div className="text-sm text-slate-500 mb-1">CLAIM:</div>
          <div className="font-medium">{opportunity.insurance.claimNumber}</div>
        </div>
        <div>
          <div className="text-sm text-slate-500 mb-1">VEHICLE OWNER:</div>
          <div className="font-medium">{opportunity.owner.name}</div>
        </div>
        <div>
          <div className="text-sm text-slate-500 mb-1">DROP DATE:</div>
          <div className="font-medium">
            {opportunity.dropDate ? format(new Date(opportunity.dropDate), 'M-dd-yy') : 'Not set'}
          </div>
        </div>
        <div>
          <div className="text-sm text-slate-500 mb-1">INSURANCE:</div>
      ...
      <div className="flex items-center justify-between pt-2 border-t border-slate-200">
        <div>
          <div className="text-sm text-slate-500 mb-1">LAST COMMUNICATION:</div>
          <div className="flex items-center gap-2">
