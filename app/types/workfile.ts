...
export enum WorkfileStatus {
  ...
  Sublets = 'Sublets', // Workfile is in sublet status
  Labor = 'Labor', // Workfile is in labor status
  Reports = 'Reports', // Workfile is in reports status
}
...
export type Workfile = {
  ...
  owner: {
    // Renamed from customer to match opportunity type
